...
export declare const BTC_FANTOM: Token;
export declare const DAI_FANTOM: Token;
export declare const ETH_FANTOM: Token;
export declare const USDC_FANTOM: Token;
export declare const USDT_FANTOM: Token;
export declare const BTC_GNOSIS: Token;
export declare const DAI_GNOSIS: Token;
export declare const ETH_GNOSIS: Token;
export declare const USDC_GNOSIS: Token;
export declare const USDT_GNOSIS: Token;
export declare const BTC_KLAYTN: Token;
export declare const DAI_KLAYTN: Token;
export declare const ETH_KLAYTN: Token;
export declare const USDC_KLAYTN: Token;
export declare const USDT_KLAYTN: Token;
