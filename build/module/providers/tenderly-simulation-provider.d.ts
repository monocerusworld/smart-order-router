...
export declare class FallbackTenderlySimulator extends Simulator {
    ...
    protected simulateTransaction(fromAddress: string, swapOptions: SwapOptions, swapRoute: SwapRoute, l2GasData?: MantaGasData): Promise<SwapRoute>;
}
export declare class TenderlySimulator extends Simulator {
    ...
    simulateTransaction(fromAddress: string, swapOptions: SwapOptions, swapRoute: SwapRoute, l2GasData?: MantaGasData): Promise<SwapRoute>;
