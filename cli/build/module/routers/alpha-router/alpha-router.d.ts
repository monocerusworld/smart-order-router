...
import { ArbitrumGasData, IL2GasDataProvider, MantaGasData } from '../../providers/v3/gas-data-provider';
...
export declare class AlphaRouter implements IRouter<AlphaRouterConfig>, ISwapToRatio<AlphaRouterConfig, SwapAndAddConfig> {
    ...
    protected l2GasDataProvider?: IL2GasDataProvider<MantaGasData> | IL2GasDataProvider<ArbitrumGasData>;
    ...
    constructor({ chainId, provider, multicall2Provider, v3PoolProvider, onChainQuoteProvider, v2PoolProvider, v2QuoteProvider, v2SubgraphProvider, tokenProvider, blockedTokenListProvider, v3SubgraphProvider, gasPriceProvider, v3GasModelFactory, v2GasModelFactory, mixedRouteGasModelFactory, swapRouterProvider, mantaGasDataProvider, tokenValidatorProvider, simulator, routeCachingProvider, }: AlphaRouterParams);
